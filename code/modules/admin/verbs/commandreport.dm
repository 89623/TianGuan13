...
ADMIN_VERB(change_command_name, R_ADMIN, "更改指挥名称", "Change the name of Central Command.", ADMIN_CATEGORY_EVENTS)
...
ADMIN_VERB(create_command_report, R_ADMIN, "创建指挥报告", "Create a command report to be sent to the station.", ADMIN_CATEGORY_EVENTS)
