...
ADMIN_VERB(toggle_hub, R_SERVER, "切换Hub", "Toggles the server's visilibility on the BYOND Hub.", ADMIN_CATEGORY_SERVER)
...
ADMIN_VERB(end_round, R_SERVER, "End 弹", "Forcibly ends the round and allows the server to restart normally.", ADMIN_CATEGORY_SERVER)
...
ADMIN_VERB(toggle_ooc, R_ADMIN, "切换OOC", "Toggle the OOC channel on or off.", ADMIN_CATEGORY_SERVER)
	toggle_ooc()
...
ADMIN_VERB(start_now, R_SERVER, "开始现在", "Start the round RIGHT NOW.", ADMIN_CATEGORY_SERVER)
...
ADMIN_VERB(toggle_ai, R_SERVER, "切换AI", "Toggle the ability to choose AI jobs.", ADMIN_CATEGORY_SERVER)
...
ADMIN_VERB(delay, R_SERVER, "延迟赛前阶段", "Delay the game start.", ADMIN_CATEGORY_SERVER)
