...
ADMIN_VERB_AND_CONTEXT_MENU(cmd_admin_subtle_message, R_ADMIN, "微妙讯息", ADMIN_VERB_NO_DESCRIPTION, ADMIN_CATEGORY_HIDDEN, mob/target in world)
...
ADMIN_VERB_AND_CONTEXT_MENU(cmd_admin_local_narrate, R_ADMIN, "本地叙述", ADMIN_VERB_NO_DESCRIPTION, ADMIN_CATEGORY_HIDDEN, atom/locale in world)
...
ADMIN_VERB_AND_CONTEXT_MENU(cmd_admin_direct_narrate, R_ADMIN, "直接叙述", ADMIN_VERB_NO_DESCRIPTION, ADMIN_CATEGORY_HIDDEN, mob/target)
...
ADMIN_VERB(cmd_admin_add_freeform_ai_law, R_ADMIN, "添加自定义 AI 法律", "Add a custom law to the Silicons.", ADMIN_CATEGORY_EVENTS)
...
ADMIN_VERB(change_sec_level, R_ADMIN, "设置安全等级", "Changes the security level. Announcement effects only.", ADMIN_CATEGORY_EVENTS)
...
ADMIN_VERB(command_report_footnote, R_FUN, "指挥报告脚注", "Adds a footnote to the roundstart command report.", ADMIN_CATEGORY_EVENTS)
...
ADMIN_VERB(command_report_content, R_FUN, "指挥报告内容", "Sets the main content of the roundstart command report.", ADMIN_CATEGORY_EVENTS)
	GLOB.communications_controller.block_command_report += 1
...
ADMIN_VERB(delay_command_report, R_FUN, "延迟指挥报告", "Prevents the roundstart command report from being sent; or forces it to send it delayed.", ADMIN_CATEGORY_EVENTS)
