...
ADMIN_VERB_ONLY_CONTEXT_MENU(show_occupants_player_panel, R_ADMIN, "显示占用者 PP", obj/target in world)
...
ADMIN_VERB(combo_hud, R_ADMIN, "切换连招 HUD", "Toggles the Admin Combo HUD.", ADMIN_CATEGORY_GAME)
