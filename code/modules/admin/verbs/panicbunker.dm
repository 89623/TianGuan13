...
ADMIN_VERB(panic_bunker, R_SERVER, "切换恐慌堡垒", "Toggles the panic bunker for the server.", ADMIN_CATEGORY_SERVER)
...
ADMIN_VERB(toggle_interviews, R_SERVER, "切换 PB 访谈", "Toggle whether new players will be interviewed or blocked from connecting.", ADMIN_CATEGORY_SERVER)
