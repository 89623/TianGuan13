...
ADMIN_VERB_ONLY_CONTEXT_MENU(cmd_admin_pm_context, R_NONE, "管理员 PM Mob", mob/target in world)
	if(!ismob(target))
		to_chat(
			src,
...
ADMIN_VERB(cmd_admin_pm_panel, R_NONE, "管理员 PM", "Show a list of clients to PM", ADMIN_CATEGORY_MAIN)
