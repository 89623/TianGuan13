...
ADMIN_VERB_AND_CONTEXT_MENU(jump_to_mob, R_ADMIN, "跳转到Mob", "Jump to any mob in the game.", ADMIN_CATEGORY_GAME, mob/target in world)
...
ADMIN_VERB(jump_to_key, R_ADMIN, "跳转到键", "Jump to a specific player.", ADMIN_CATEGORY_GAME)
...
ADMIN_VERB(jump_to_ghost, R_ADMIN, "跳转到幽灵", "Jump your body to your Aghost.", ADMIN_CATEGORY_GAME)
...
ADMIN_VERB_AND_CONTEXT_MENU(get_mob, R_ADMIN, "获得 Mob", "Teleport a mob to your location.", ADMIN_CATEGORY_GAME, mob/target in world)
...
ADMIN_VERB(get_key, R_ADMIN, "获得键", "Teleport the player with the provided key to you.", ADMIN_CATEGORY_GAME)
	var/list/keys = list()
	for(var/mob/M in GLOB.player_list)
		keys += M.client
	var/client/selection = input(user, LANG("datum.49fce9a4", null), LANG("datum.a34d9875", null)) as null|anything in sort_key(keys)
