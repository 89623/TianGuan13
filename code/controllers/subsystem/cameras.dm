...
ADMIN_VERB(pause_camera_updates, R_ADMIN, "切换摄像头更新", "Stop security cameras from updating, meaning what they see now is what they will see forever.", ADMIN_CATEGORY_DEBUG)
